  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (supabaseError) {
        ...
        setError('Error al validar el código. Por favor, inténtelo de nuevo.')
        setIsLoading(false)
        return
      }
      ...
      <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-green-50 p-4">
        <div className="spinner-container flex flex-col items-center justify-center">
          ...
          <div className="mt-6 text-center">
            <div className="text-xl font-semibold text-gray-700 mb-2">Cargando</div>
            <div className="text-lg text-gray-500">
              Listo en <span className="font-bold text-blue-600">{countdown}</span> segundo{countdown > 1 ? 's' : ''}
            </div>
          </div>
    ...
    return (
      <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-green-50 p-4">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-4">¡Código validado con éxito!</h1>
      ...
      <div className="w-full max-w-md">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                required
                maxLength={8}
                title="Por favor, ingrese el código"
                disabled={isLoading}
              />
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <div className="inline-flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-lg">
            ...
            <span>Verificación segura en curso</span>
          </div>
        </div>
      </div>
    </main>
